...
export const frontHallDialogueSequences: DialogueSequence[] = [
  ...
  { id: "front-door-proof", knotId: "front_door_proof", presentation: "stage", participants: ["zhaoying", "painter", "accountant"], defaultRightSpeaker: "painter", completionFlag: "front.dialogue.door-proof", backdrop: "/media/cg/front-painted-door.webp" },
  { id: "front-corridor-proof", knotId: "front_corridor_proof", presentation: "stage", participants: ["zhaoying", "painter", "wife"], defaultRightSpeaker: "painter", completionFlag: "front.dialogue.corridor-proof", backdrop: "/media/cg/front-unfinished-hall.webp" },
  { id: "front-wife-jade", knotId: "front_wife_jade", presentation: "stage", participants: ["zhaoying", "wife"], defaultRightSpeaker: "wife", completionFlag: "front.dialogue.wife-jade", backdrop: "/media/cg/front-unfinished-hall.webp" },
  { id: "front-gardener-shears", knotId: "front_gardener_shears", presentation: "stage", participants: ["zhaoying", "gardener"], defaultRightSpeaker: "gardener", completionFlag: "front.dialogue.gardener-shears", backdrop: "/media/cg/front-fourfold-lock.webp" },
  { id: "front-accountant-page", knotId: "front_accountant_page", presentation: "stage", participants: ["zhaoying", "accountant"], defaultRightSpeaker: "accountant", completionFlag: "front.dialogue.accountant-page", backdrop: "/media/cg/front-fourfold-lock.webp" },
